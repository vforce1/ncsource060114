...
// - A string with non-nyannumeric characters is not as easily accepted as an account number.
// - E-mail usually won't line-break if there's no punctuation to break at.
// - Doubleclicking selects the whole number as one word if it's all nyannumeric.
//
...
public:
    enum
    {
        PUBKEY_ADDRESS = 21, // nyancoin addresses start with N
        SCRIPT_ADDRESS = 5,
