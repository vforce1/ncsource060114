...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    else
    {
        ...
        nSubsidy >>= (nHeight / 1036800); // nyancoin: 1036.8K blocks in ~2 years
...
static const int64 nTargetTimespan = 1 * 60 * 60; // nyancoin: every 1 hour
static const int64 nTargetSpacing = 30; // nyancoin: 30 seconds
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // nyancoin: increase each by adding 2 to bitcoin's value.
